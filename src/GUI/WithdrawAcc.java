	...
	public WithdrawAcc() {
		...
		btnDeposit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String amtStr = textField_1.getText();
				double amt;

				if (aacountNum.isEmpty() || amtStr.isEmpty()) {
					JOptionPane.showMessageDialog(getComponent(0), "Please fill all fields.");
					return;
				}
				...
				try {
					...
					JOptionPane.showMessageDialog(getComponent(0), "Amount must be a valid number.");
